...
var ASM_CONSTS = {
 ...
 1975922: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 1976005: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 1976074: () => { return window.innerWidth; },  
 1976104: () => { return window.innerHeight; }
};
