...
var ASM_CONSTS = {
 ...
 13168146: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 13168229: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 13168298: () => { return window.innerWidth; },  
 13168328: () => { return window.innerHeight; }
};
